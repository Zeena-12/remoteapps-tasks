...
@NgModule({
  declarations: [InputComponent, CardComponent, BottomNavComponent, StatusBoxComponent, ProfileCardComponent, CalendarComponent, DropdownComponent,ActionSheetComponent, CvComponent, RaStarRatingComponent ],
  imports: [
    CommonModule,
  ...
  exports: [InputComponent, CardComponent, BottomNavComponent, StatusBoxComponent, ProfileCardComponent, CalendarComponent, DropdownComponent,ActionSheetComponent, CvComponent, RaStarRatingComponent ]  // Export the component for use in other modules
})
